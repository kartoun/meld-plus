...
all_scores_string = paste(paste(paste(paste(paste(paste(paste(paste('MELD:', MELD, ''), ', MELD-Na:', ''), MELD_Na, ''), ', MELD_Plus_7_Varaibles:', ''), MELD_Plus_7_Varaibles, ''), ', MELD_Plus_9_Varaibles:', ''), MELD_Plus_9_Varaibles, ''))
